...
if( superfish ){
    ...
    rv: 0,
    suff: ['com'],
    bl: 'facebook.youtube.baidu.linkedin.qq.microsoft.flickr.sahibinden.taobao.trendyol.markafoni.360buy.dcinside.booking',
    html: '',
    ...
    isStore: function(){
        ...
        var c = this.html.match(/(add\s?to\s?(my)?\s?(shopping)?\s?(cart|bag|basket))|free shipping|order now|shop now/ig);
        if (c) {
            return 1;
        }
    ...
    _google : {
        ...
        searchget: function() {
            ...
            if ( superfish.b.searchget && ssg ) {
                ...
                else if (iu("books.google") ||  iu( "tbs=shop" ) ||  iu( "tbs=bks" )) {
...
superfish.b = {};
        ...
        superfish.b.ip              = "187.54.153.78";
        superfish.b.userid          = "chrome0000000000";
        superfish.b.appVersion      = "6.9.7";
...
superfish.publisher.send = function() {
    if (superfish.b.multiImg && this.reqCount < this.imgs.length) {
        ...
        spsupport.api.validateSU( this.imgs[this.reqCount], parseInt( imgPos.y + this.imgs[this.reqCount].height - 45 ));
        this.reqCount++;
    }
    else {
